					...
					<div class="col-lg-6">
						...
						<div class="pt-5">
							...
							<ul class="comment-list">
								<c:forEach var="successfullUserDonation"
									items="${successfullUserDonations}">
									<li class="comment">
										<div class="vcard bio">
											<img
										...
										<div class="comment-body">
											<h3>${successfullUserDonation.name}</h3>
											<div class="meta" style="color: #373b3e !important">${successfullUserDonation.date}</div>
											<p>${successfullUserDonation.money}VNĐ</p>
										</div>
									</li>
								</c:forEach>
							</ul>
						...
						<div class="bg-light p-3 border rounded mb-4">
							...
							<ul class="list-unstyled pl-3 mb-0">
								<li class="mb-2"><strong class="text-black">Mã đợt
										quyên góp: </strong><span>${donation.code}</span></li>
								<li class="mb-2"><strong class="text-black">Tên
										đợt quyên góp: </strong><span>${donation.name}</span></li>
								<li class="mb-2"><strong class="text-black">Ngày
										bắt đầu: </strong><span>${donation.startDate}</span></li>
								<li class="mb-2"><strong class="text-black">Ngày
										kết thúc: </strong><span>${donation.endDate}</span></li>
								<li class="mb-2"><strong class="text-black">Cá
										nhân/Tổ chức: </strong><span>${donation.organizationName}</span></li>
								<li class="mb-2"><strong class="text-black">Số
										điện thoại: </strong><span>${donation.phoneNumber}</span></li>
								<li class="mb-2"><strong class="text-black">Tổng
										tiền quyên góp nhận được: </strong><span>${donation.money} VNĐ</span></li>
								<li class="mb-2"><strong class="text-black">Trạng
										thái:</strong> <c:if test="${donation.status == 1}">
										<span>Mới tạo</span>
									</c:if> <c:if test="${donation.status == 2}">
										<span>Đang quyên góp</span>
									</c:if> <c:if test="${donation.status == 3}">
										<span>Kết thúc quyên góp</span>
									</c:if> <c:if test="${donation.status == 4}">
										...
										<div class="row">
											...
											<div class="col-12">
												...
												<input type="text" class="form-control" id="addname"
													name="name" required> <label for="addname"
												...
												<input type="hidden" class="form-control" id="addname"
													name="donationId" value="${donation.id}"> <label
													for="addname" class="col-form-label">Lời nhắn:</label>
