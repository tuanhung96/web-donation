...
<html lang="en">
  <head>
    ...
    <link href="<c:url value="/resources/admin1/assets/css/styles.css" />" rel="stylesheet">
    ...
    <script src="<c:url value="/resources/admin1/assets/js/JQuery3.3.1.js" />"></script>
    <script src="<c:url value="/resources/admin1/assets/js/scripts.js" />"></script>
    <script src="<c:url value="/resources/admin1/assets/js/datatables-simple-demo.js" />"></script>
